...
public class TableList {
	...
	private Table tail;
	private int tables;
	private enum SideEnum {LEFT, RIGHT}
	...
	public TableList mergeSort ( TableList tables_ )
	{
		TableList right = new TableList();
		TableList left = new TableList();
		
		if( tables_.size() <= 1 ) { return tables_; }
		else {
